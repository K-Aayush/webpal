...
const FeedbackCard = ({ content, name, title }: feedbackcard) => {
    ...
    return (
        <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 bg-gradient-to-tr from-gray-200 to-gray-100 hover:bg-gradient-to-tr hover:from-gray-300 hover:to-gray-200">
